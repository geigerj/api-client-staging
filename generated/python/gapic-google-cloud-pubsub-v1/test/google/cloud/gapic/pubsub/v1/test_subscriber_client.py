...
class TestSubscriberClient(unittest.TestCase):
    ...
    def test_create_subscription(self, mock_create_stub):
        ...
        self.assertEqual(topic, actual_request.topic)
    ...
    def test_get_subscription(self, mock_create_stub):
        ...
        self.assertEqual(subscription, actual_request.subscription)
    ...
    def test_update_subscription(self, mock_create_stub):
        ...
        self.assertEqual(subscription, actual_request.subscription)
        self.assertEqual(update_mask, actual_request.update_mask)
    ...
    def test_list_subscriptions(self, mock_create_stub):
        ...
        self.assertEqual(project, actual_request.project)
    ...
    def test_modify_ack_deadline(self, mock_create_stub):
        ...
        self.assertEqual(subscription, actual_request.subscription)
        self.assertEqual(ack_ids, actual_request.ack_ids)
        self.assertEqual(ack_deadline_seconds,
                         actual_request.ack_deadline_seconds)
    ...
    def test_pull(self, mock_create_stub):
        ...
        self.assertEqual(subscription, actual_request.subscription)
        self.assertEqual(max_messages, actual_request.max_messages)
    ...
    def test_modify_push_config(self, mock_create_stub):
        ...
        self.assertEqual(subscription, actual_request.subscription)
        self.assertEqual(push_config, actual_request.push_config)
    ...
    def test_delete_snapshot(self, mock_create_stub):
        ...
        self.assertEqual(snapshot, actual_request.snapshot)
    ...
    def test_set_iam_policy(self, mock_create_stub):
        ...
        self.assertEqual(policy, actual_request.policy)
    ...
    def test_test_iam_permissions(self, mock_create_stub):
        ...
        self.assertEqual(resource, actual_request.resource)
        self.assertEqual(permissions, actual_request.permissions)
